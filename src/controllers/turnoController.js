...
exports.create = async (req, res, next) => {
  try {
    ...
    if (!personalId || !fecha) {
      return res
        .status(400)
        .json({ message: 'Debe enviar personalId y fecha' });
    }

    // Los tres bloques que siempre queremos crear
    const bloques = [
      { horario_inicio: '09:00', horario_fin: '12:00' },
      { horario_inicio: '14:00', horario_fin: '18:00' },
      { horario_inicio: '18:00', horario_fin: '23:00' },
    ];

    // Crear los 3 turnos en paralelo
